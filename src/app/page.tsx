...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-24 pt-24 sm:px-6 lg:px-8 lg:pb-32 lg:pt-32">
          <div className="max-w-2xl">
            <Reveal>
              <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-ink-950/60 px-3 py-1 text-xs font-medium text-brand-200 backdrop-blur">
            ...
            <Reveal delay={0.05}>
              <h1 className="mt-5 font-display text-4xl font-extrabold leading-[1.04] tracking-tight text-white sm:text-6xl">
                ...
                <span className="text-gradient">Google reviews</span> — before
            ...
            <Reveal delay={0.2}>
              <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-slate-300">
                ...
                <span className="inline-flex items-center gap-1.5">
                  <Smartphone className="h-4 w-4 text-cyanx-400" />
          ...
          <Reveal>
            <div>
              ...
              <p className="mt-5 text-slate-300">
                ...
                <strong className="text-white">98% of consumers</strong>. And
                your rating decides whether they pick you or the shop down the
                street.
              </p>
              <p className="mt-4 text-slate-300">
                ...
                cuts it to <strong className="text-white">one tap, at the
                counter, while they&apos;re still smiling</strong>.
              </p>
            </div>
          </Reveal>
          <Reveal delay={0.1}>
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                >
                  ...
                  <p className="mt-2 text-sm text-slate-400">{s.small}</p>
                </div>
              ))}
            </div>
          </Reveal>
        ...
        <Reveal>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-3 text-slate-400">
              The best time to ask for a review is the moment you hand back the
              card reader. Here&apos;s the play, step by step.
            </p>
          </div>
        </Reveal>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Reveal key={biz.name} delay={i * 0.05}>
              <div className="group relative h-64 overflow-hidden rounded-2xl border border-white/10">
                ...
                <div className="absolute bottom-0 p-5">
                  ...
                  <p className="mt-1 text-sm text-slate-300">{biz.line}</p>
                </div>
              </div>
            </Reveal>
          ))}
          <Reveal delay={0.25}>
            <Link
              href="/contact"
              className="flex h-64 flex-col items-center justify-center gap-3 rounded-2xl border border-dashed border-white/20 bg-ink-900 p-5 text-center transition-colors hover:border-brand-400"
            >
            ...
            <table className="w-full min-w-[640px] text-left text-sm">
              <thead>
                <tr className="border-b border-white/10 bg-ink-900">
                  <th className="p-4 font-semibold text-slate-300"> </th>
                  <th className="p-4 font-display text-base font-bold text-white">
                    <span className="text-gradient">TapLink NFC</span>
                  </th>
                  <th className="p-4 font-semibold text-slate-300">Paper QR code</th>
                  <th className="p-4 font-semibold text-slate-300">Just asking</th>
                </tr>
              </thead>
              <tbody>
                {comparison.map((row) => (
                  <tr key={row.label} className="border-b border-white/5 last:border-0">
                    ...
                    {[row.nfc, row.qr, row.asking].map((cell, i) => (
                      <td key={i} className="p-4 text-slate-400">
                        {cell === true ? (
            ...
            <div className="relative grid items-center gap-8 p-8 sm:p-12 lg:grid-cols-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={p.title}
                    className="rounded-2xl border border-white/10 bg-ink-950/70 p-5 backdrop-blur"
                  >
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <Reveal>
          <div className="flex flex-col items-center gap-6 rounded-3xl border border-emerald-400/20 bg-emerald-400/5 p-10 text-center sm:p-14">
            ...
            <p className="max-w-xl text-slate-300">
              ...
              no forms, no restocking fee. And if a card ever stops scanning,
              we replace it free. That&apos;s the whole policy.
            </p>
