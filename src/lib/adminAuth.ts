 ...
 *
 * The password comes from the ADMIN_PASSWORD env var. Until that is set, a
 * default of "taplink-admin" is used so the dashboard works out of the box;
 * the UI shows a warning until the env var exists. Set it in Vercel >
 * Settings > Environment Variables and redeploy.
 */

const DEFAULT_PASSWORD = "taplink-admin";
