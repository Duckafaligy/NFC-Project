...
export function LegalLayout({
  ...
  return (
    <section className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 space-y-6 text-neutral-600">{children}</div>

      <div className="mt-12 rounded-md border border-neutral-200 bg-neutral-50 p-4 text-sm text-neutral-600">
